...
export class InitialMigration1777260480308 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" (
            ...
            "type" "public"."users_type_enum" NOT NULL DEFAULT 'employee', 
            CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), 
            CONSTRAINT "UQ_9fe1d41682c0112df58dc745057" UNIQUE ("nip"), 
        ...
        await queryRunner.query(`CREATE TABLE "menus" (
            ...
            "isIndent" boolean NOT NULL DEFAULT false, 
            "availableActions" jsonb,
            "parentClass" character varying, 
            "aclName" character varying, 
            "aclParam" character varying, 
            "parentId" uuid, 
            "moduleId" uuid, 
            CONSTRAINT "PK_3fec3d93327f4538e0cbd4349c4" PRIMARY KEY ("id")
        )`);

        await queryRunner.query(`CREATE TABLE "role-menus" (
            "id" uuid NOT NULL, 
            "is_active" boolean NOT NULL DEFAULT true, 
            "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, 
            "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, 
            ...
            "roleId" uuid, 
            "menuId" uuid, 
            CONSTRAINT "UQ_c885f44ad0b0806fcac33ed7d92" UNIQUE ("roleId", "menuId"), 
            CONSTRAINT "PK_2546fafbc60959259761a67f191" PRIMARY KEY ("id")
        )`);

        await queryRunner.query(`CREATE TABLE "role_modules" (
            "id" uuid NOT NULL, 
            "is_active" boolean NOT NULL DEFAULT true, 
            "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, 
            "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, 
            "roleId" uuid, 
            "moduleId" uuid, 
            CONSTRAINT "UQ_2ccda4b46a7fe72c45403952183" UNIQUE ("roleId", "moduleId"), 
            CONSTRAINT "PK_39cccfce9ba045b2887019727d5" PRIMARY KEY ("id")
        )`);
        ...
        await queryRunner.query(`CREATE TABLE "user_roles" (
            ...
            "userId" uuid, 
            "roleId" uuid, 
            CONSTRAINT "UQ_88481b0c4ed9ada47e9fdd67475" UNIQUE ("userId", "roleId"), 
